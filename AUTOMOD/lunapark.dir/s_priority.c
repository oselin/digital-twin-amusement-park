...
static int32
am_S_priority(load* this, int32 step, void* args)
{
...
Label1: ;  /* Step1 */
	{
		{
			pushppa(this, am_S_priority, Step 2, am_localargs);
...
Label2: ; // Step 2
		}
		{
			if (am2_que[ValidIndex("am_model.am_que", this->attribute->am2_roller[ValidIndex("am_model.am_roller", this->attribute->am2_cc, 10)], 5)] < QueGetCapacity(ValidPtr(&(am2_Q_roll[ValidIndex("am_model.am_Q_roll", this->attribute->am2_roller[ValidIndex("am_model.am_roller", this->attribute->am2_cc, 10)], 5)]), 50, queue*)) - 1) {
				...
				{
					return waitorder(&(am2_OL_roller[ValidIndex("am_model.am_OL_roller", this->attribute->am2_roller[ValidIndex("am_model.am_roller", this->attribute->am2_cc, 10)], 5)]), this, am_S_priority, Step 3, am_localargs);
Label3: ; // Step 3
...
LabelRet: ;
	if (am_localargs)
		xfree(am_localargs);
	return retval;
} /* end of am_S_priority */



/* init function for S_priority.m */
void
model_S_priority_init(struct model_struct* data)
{
	data->am_S_priority = am_S_priority;
}
