...
char CommandName[] = "C:/AutoMod/12__6/bin/amod.exe";
...
get_ldatt_address(load* this, int32 index, int32* d)
{
	...
	switch(index) {
	case 0:
		data = (void*)&this->attribute->am_model.am_ticket;
		break;
	case 1:
		data = (void*)&this->attribute->am_model.am_cc;
		break;
	case 2:
		data = (void*)&this->attribute->am_model.am_roller[d[0]];
		break;
	case 3:
		data = (void*)&this->attribute->am_model.am_prior[d[0]];
		break;
	case 4:
		data = (void*)&this->attribute->am_model.am_id;
		break;
	case 5:
		data = (void*)&this->attribute->am_model.am_arrival_time;
		break;
	case 6:
		data = (void*)&this->attribute->am_model.am_flag;
		break;
	}
	return data;
}
...
set_attdata(load* this)
{
	...
	am_model.am_ticket$att->data = (void*)&this->attribute->am_model.am_ticket;
	am_model.am_cc$att->data = (void*)&this->attribute->am_model.am_cc;
	am_model.am_roller$att->data = (void*)this->attribute->am_model.am_roller;
	am_model.am_prior$att->data = (void*)this->attribute->am_model.am_prior;
	am_model.am_id$att->data = (void*)&this->attribute->am_model.am_id;
	am_model.am_arrival_time$att->data = (void*)&this->attribute->am_model.am_arrival_time;
	am_model.am_flag$att->data = (void*)&this->attribute->am_model.am_flag;
}
